// I made this program by using awt and swing classes as following
...
public class CalculatorSimp implements ActionListener {
   ...
   private static void createUI(JFrame frame) {
      ...
      CalculatorSimp calculator = new CalculatorSimp();
...
// for creating buttons as following function
...
//below function will add action listner to button as below
...
//for all buttons also inputbox for location as x,y location.
      ...
      gbc.gridx = 3; gbc.gridy = 0; panel.add(buttonEquals, gbc);
      frame.getContentPane().add(panel, BorderLayout.CENTER);        
   }
// main logic for calculator starts here
...
//user can innput any value so first it converts double and then value i.e. returns in double as below
      if (operator.equals("+"))
